      ...
      <el-row :gutter="20">
        <el-col :span="6">
          <div class="total-frame">
            ...
            <div class="total-value">{{total_product}}</div>
          </div>
        </el-col>
        <el-col :span="6">
          <div class="total-frame">
            ...
            <div class="total-value">{{total_order}}</div>
          </div>
        </el-col>
        <el-col :span="6">
          <div class="total-frame">
            ...
            <div class="total-value">{{total_role}}</div>
          </div>
        </el-col>
        <!--<el-col :span="6">-->
          <!--<div class="total-frame">-->
...
<script>
  ...
  import {fetchList as fetchList_product} from '@/api/product'
  import {fetchList as fetchList_order} from '@/api/order'
  import {fetchList as fetchList_role} from '@/api/login';
  ...
  export default {
    ...
    methods:{
      getInfo() {
        fetchList_product(this.listQuery).then(response => {
          console.log(response)
          this.total_product = response.data.total;
        });
        fetchList_order(this.listQuery).then(response => {
          console.log(response)
          this.total_order = response.data.total;
        });
        fetchList_role(this.listQuery).then(response => {
          console.log(response)
          this.total_role = response.data.total;
        });
      },
      handleDateChange(){
        this.getData();
